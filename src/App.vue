  ...
  <body>
    <div class="carnet">
      <aside>
        ...
        <img src="./assets/img/foto_elon.jpg" alt="Foto de Elon">
        <p>RUN {{ run }}</p>
      </aside>
      <main>
        <header>
        ...
        <section>
          ...
          <div class="grid-2-colums">
            ...
            <article>
              ...
              <span>{{ numero_de_documento }}</span>
            </article>
          </div>
          <div class="grid-2-colums">
            <article>
              <header>FECHA DE EMISIÒN</header>
              <span>{{ fecha_de_emision }}</span>
            </article>
            <article>
              <header>FECHA DE VENCIMIENTO</header>
              <span>{{ fecha_de_vencimiento }}</span>
            </article>
          </div>
          <article>
...
export default {
  ...
  data() {
    return {
      ...
      sexo: "M",
      fecha_de_nacimiento: "28 JUN 1971",
      numero_de_documento: "222.222.222",
      fecha_de_emision: "01 ENE 2025",
      fecha_de_vencimiento: "01 ENE 2030",
      firma: "X Æ A-12"
    }
  }
}
